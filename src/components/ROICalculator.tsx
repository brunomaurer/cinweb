...
interface ROIResult { monthlySaving: number; annualBenefit: number; roi: number; paybackMonths: number; monthlyCost: number; }
        ...
        <div className="max-w-3xl mx-auto">
          <div className="card-elevated p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-heading-sm font-bold text-gray-900">{t.roiCalc.headline}</h3>
            </div>
            ...
            {calculated && result && (
              <div className="mt-8 animate-fade-up">
                ...
                <div className="mt-6 text-center">
                  <a href="#roi-lead" className="btn-primary text-body px-8 py-4">{t.roiLead.cta}<ArrowRight className="w-4 h-4" /></a>
                </div>
              </div>
            )}
          </div>
